...
function add(div){
    var split_input = document.createElement('input');
    split_input.setAttribute('type', 'text');
    split_input.setAttribute('name', 'organizers[]');
    split_input.setAttribute('class', 'class-input');

    var btn = document.getElementById(div);
    btn.insertBefore(split_input, null);
}
