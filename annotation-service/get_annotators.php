...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        "train_current_qa_task" => $row['train_current_qa_task'], "train_current_valid_task" => $row['train_current_valid_task'], "finished_norm_annotations" => $row['finished_norm_annotations'], "finished_qa_annotations" => $row['finished_qa_annotations'], 
