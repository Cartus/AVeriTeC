...
$sql = 'UPDATE Annotators SET current_norm_task=NULL, finished_norm_annotations=0, skipped_norm_data=0, p1_time_sum=0, p1_load_sum=0, p1_speed_trap=0, p1_timed_out=0, p1_assigned=0 WHERE user_id=42';
