...
if ($result->num_rows > 0) {
    ...
    $phase_2 = (["training_annotations_done" => $row['train_finished_qa_annotations'], "training_annotations_assigned" => $row['train_p2_assigned'],
        "average_questions_p2" => $average_questions_p2, "annotations_done" => $row['finished_qa_annotations'], "annotations_assigned" => $row['p2_assigned'], "skipped_claims_percentage" => $p2_skipped_percent,
