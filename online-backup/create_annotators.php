...
train_current_norm_task INT(6),
train_current_qa_task INT(6),
train_current_valid_task INT(6),
...
train_finished_norm_annotations INT(6) NOT NULL,
train_finished_qa_annotations INT(6) NOT NULL,
train_finished_valid_annotations INT(6) NOT NULL,
...
p4_assigned INT(6),
p5_assigned INT(6),
train_p1_assigned INT(6),
train_p2_assigned INT(6),
train_p3_assigned INT(6)
)";
