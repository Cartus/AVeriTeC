...
<div class="login-form">
    <form  method="post">
        ...
        <div class="form-group">
            <label>
                <input type="radio" name="mode" id="cn" value="claim_normalization">
                Claim Normalization
            </label>
        </div>
        <div class="form-group">
            <label>
                <input type="radio" name="mode" id="qa" value="question_answering">
                Question Answering
            </label>
        </div>
        <div class="form-group">
            <label>
                <input type="radio" name="mode" id="vv" value="verdict_validation">
                Verdict Validation
            </label>
        </div>
        <div class="form-group">
            <button type="button" id='login-button' class="btn btn-primary btn-block">Sign Up</button>
        </div>
    </form>
</div>
</body>
