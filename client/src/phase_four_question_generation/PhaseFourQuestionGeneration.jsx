  ...
  render() {
    ...
    const steps = [
      ...
      },
      {
        ...
        content: "Read the questions generated by the previous annotators, along with any issues they may have identified with these questions. You can modify these as you please in order to produce questions that will better support a verdict."
      },
      {
    ...
    Object.keys(this.state.entries).forEach(key => {
      ...
      all_entries[new_key] = this.state.entries[key]
    })

    Object.keys(this.state.previous_entries).forEach(key => {
      var new_key = key + "_previous"
      all_entries[new_key] = this.state.previous_entries[key]
    })
      ...
      <QAPageDiv>
        {!this.state.confirmation ?
          <TourProvider steps={steps}>
            <QAPageView claim={this.state.claim} phase={4}/>
            <QADataField>
