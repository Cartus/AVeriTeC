      ...
      <TextRightEntryDiv>
        <div data-tour="answer_metadata">
          ...
          {unanswerable ?
            ...
            :
            <SelectWithTooltip readOnly={this.props.posthocView} name="source_medium" label="Source Medium" value={this.props.data["source_medium"]} onChange={this.props.handleFieldChange} required validator={notEmptyValidator} items={["Web text", "Web table", "PDF", "Image/graphic", "Video", "Audio", "Metadata", "Other"]} tooltip="Please describe what medium you found the answer in." />
          }
        </div>
      </TextRightEntryDiv>
    </EntryCard>
