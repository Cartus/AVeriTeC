...
<html>
<head>
    <link rel="stylesheet" href="css/style_question_answering.css">
    ...
    <script src="js/question_answering.js"></script>
...
<div class="menu-frame" id="my-menu-frame">
    ...
    <div class="question-div" id="question-div">
        <span  id='question' class="box-label">Question:</span>
        <input type="text"  spellcheck="true" class='class-input' id='question' value="">
        <input type="button" onclick="add_text('question-div');" value="Add Question" />
    ...
    <div class="answer-div" id="answer-div">
        <span  id='answer' class="box-label">Answer:</span>
        <textarea id='answer' class='class-input' value=""></textarea>
        <input type="button" onclick="add_textarea('answer-div');" value="Add Answer" />
